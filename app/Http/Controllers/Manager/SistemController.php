...
class SistemController extends Controller
{
    public function index()
    {
        ...
        return view('manager.sistem.index', compact('totalTunggakan'));
    }
    ...
    public function kirimPengingat(Request $request)
    {
        ...
        return redirect()->route('sistem.index')->with('success', "Berhasil menyiarkan $terkirim notifikasi pengingat iuran ke sistem log!");
    }
