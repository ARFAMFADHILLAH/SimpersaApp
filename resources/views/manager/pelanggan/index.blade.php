        ...
        <main class="flex-1 py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Daftar Pelanggan Terregistrasi</h3>
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="border-b bg-gray-50">
                                    <th class="p-3 text-sm font-semibold text-gray-600">No Pelanggan</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($dataPelanggan as $plg)
                                    <tr class="border-b hover:bg-gray-50 transition">
                                        <td class="p-3 text-sm text-indigo-600 font-bold">{{ $plg->no_pelanggan }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="p-4 text-center text-sm text-gray-500">Belum ada data pelanggan yang terdaftar.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
