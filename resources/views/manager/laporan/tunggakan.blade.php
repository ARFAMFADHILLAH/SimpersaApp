            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Monitoring pelanggan yang menunggak iuran</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                        <span class="text-xs text-gray-500">Pelanggan Menunggak</span>
                        <p class="text-lg font-bold text-red-600">{{ $jumlahPelangganTunggak }} Warga</p>
                    </div>
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @forelse($tunggakan as $t)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 font-mono text-xs">{{ $t->no_pelanggan }}</td>
                                        <td class="px-6 py-4 font-medium">{{ $t->nama_pelanggan }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-8 text-center text-gray-400">Tidak ada pelanggan yang menunggak. Semua iuran lunas!</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
