        ...
        <main class="flex-1 py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Laporan Pelanggan</h2>
                        <p class="text-sm text-gray-500">Status & data kepelangganan</p>
                    </div>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse($pelanggan as $p)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 font-mono text-xs">{{ $p->no_pelanggan }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-gray-400">Belum ada data pelanggan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
