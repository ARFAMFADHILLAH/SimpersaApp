    ...
    <div class="flex flex-col md:flex-row min-h-screen bg-gray-100 pb-24 md:pb-0">
        ...
        <main class="flex-1 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <form action="{{ route('manager.rute.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    @csrf
                    <div>
                        ...
                        @forelse($dataRute as $rt)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="p-3 text-sm">
                                    <a href="{{ route('manager.rute.peta', $rt->id) }}" class="inline-flex items-center px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white text-xs font-bold rounded">
