                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Warga</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($pengaduan as $item)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm font-medium">{{ $item->warga?->user?->name ?? '-' }}</td>
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="{{ route('admin.pengaduan.show', $item->id) }}" class="text-cyan-600 hover:underline text-sm">Detail</a>
                                    </td>
                                </tr>
                            @empty
