                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($pelanggan as $p)
                                    <tr>
                                        <td class="px-4 py-3 text-sm">{{ $p->no_pelanggan }}</td>
                                        ...
                                        <td class="px-4 py-3">
                                            <a href="{{ route('administrasi.master.pelanggan.edit', $p->id) }}" class="text-cyan-600 hover:underline text-sm">Edit</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($tpsList as $t)
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <a href="{{ route('administrasi.master.tps.edit', $t->id) }}" class="text-cyan-600 hover:underline text-sm">Edit</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($armada as $a)
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">
                                            <a href="{{ route('administrasi.master.armada.edit', $a->id) }}" class="text-cyan-600 hover:underline text-sm">Edit</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
