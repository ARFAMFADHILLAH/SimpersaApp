            ...
            <div class="max-w-3xl mx-auto space-y-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    ...
                    <dl class="grid grid-cols-2 gap-4 text-sm">
                        <div><dt class="text-gray-500">Pelanggan</dt><dd class="font-medium">{{ $pengaduan->pelanggan?->user?->name ?? '-' }}</dd></div>
                ...
                @if($pengaduan->status_respon != 'Selesai')
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <form method="POST" action="{{ route('administrasi.pengaduan.verifikasi', $pengaduan->id) }}">
                            @csrf
                            <div class="space-y-4">
                                <div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <form method="POST" action="{{ route('administrasi.pengaduan.dispatch', $pengaduan->id) }}">
                            @csrf
                            <div class="space-y-4">
                                <div>
                ...
                <a href="{{ route('administrasi.pengaduan.index') }}" class="text-cyan-600 hover:underline text-sm">&larr; Kembali</a>
            </div>
        </main>
    </div>
