<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-zinc-900 border-t border-zinc-800 text-white flex justify-around py-2.5 px-2 z-50 shadow-2xl">
    <a href="{{ route('pelanggan.dashboard') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('pelanggan.dashboard') ? 'text-indigo-400 font-bold' : 'text-zinc-400' }}">
    ...
    <a href="{{ route('pelanggan.profile') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('pelanggan.profile*') ? 'text-indigo-400 font-bold' : 'text-zinc-400' }}">
    ...
    <a href="{{ route('pelanggan.iuran.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('pelanggan.iuran*') ? 'text-indigo-400 font-bold' : 'text-zinc-400' }}">
        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        <span class="text-[10px]">Tagihan</span>
    </a>
    <a href="{{ route('pelanggan.pengaduan.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('pelanggan.pengaduan*') ? 'text-indigo-400 font-bold' : 'text-zinc-400' }}">
    ...
    <a href="{{ route('pelanggan.notifikasi.index') }}" class="flex flex-col items-center gap-1 {{ request()->routeIs('pelanggan.notifikasi*') ? 'text-indigo-400 font-bold' : 'text-zinc-400' }}">
