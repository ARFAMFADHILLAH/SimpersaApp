    ...
    <aside class="w-64 bg-[#1b1b18] text-white flex flex-col shrink-0 md:min-h-screen shadow-xl
        ...
        <div class="px-6 py-5 border-b border-zinc-800 flex items-center gap-3">
            ...
            <div>
                ...
                <span class="text-[10px] text-green-500 font-semibold uppercase tracking-widest mt-0.5 block">Petugas Lapangan</span>
            </div>
        </div>

        <div class="flex-1 py-4 space-y-1 overflow-y-auto px-3">
            ...
            <a href="{{ route('petugas.rute.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('petugas.rute.*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
            ...
            <a href="{{ route('petugas.pengangkutan.create') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('petugas.pengangkutan.*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
            ...
            <a href="{{ route('petugas.pengaduan.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('petugas.pengaduan.*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
            ...
            <a href="{{ route('petugas.laporan.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('petugas.laporan.*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
