    ...
    <aside class="w-64 bg-[#1b1b18] text-white flex flex-col shrink-0 md:min-h-screen shadow-xl
        ...
        <div class="px-6 py-5 border-b border-zinc-800 flex items-center gap-3">
            ...
            <div>
                ...
                <span class="text-[10px] text-green-500 font-semibold uppercase tracking-widest mt-0.5 block">Warga</span>
            </div>
        </div>
            ...
            <div class="px-4">
                ...
                <div class="space-y-1">
                    <a href="{{ route('warga.dashboard') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('warga.dashboard') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition font-medium">
                    ...
                    <a href="{{ route('warga.profile') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('warga.profile*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition font-medium">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                        Profil & Riwayat
                    </a>

                    <a href="{{ route('warga.iuran.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('warga.iuran*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition font-medium">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        Tagihan & Pembayaran
                    </a>

                    <a href="{{ route('warga.bank-sampah.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('warga.bank-sampah*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition font-medium">
                    ...
                    <a href="{{ route('warga.pengaduan.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('warga.pengaduan*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition font-medium">
                    ...
                    <a href="{{ route('warga.notifikasi.index') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('warga.notifikasi*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition font-medium">
