    ...
    <aside class="w-64 bg-[#1b1b18] text-white flex flex-col shrink-0 md:min-h-screen shadow-xl
        ...
        <div class="flex-1 py-4 space-y-6 overflow-y-auto">
            ...
            <div class="px-4">
                ...
                <div class="space-y-1">
                    <a href="{{ route('owner.laporan.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.laporan.index') || request()->routeIs('owner.laporan.kas') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
                    ...
                    <a href="{{ route('owner.stok.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.stok.*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
                    ...
                    <a href="{{ route('owner.laporan.pembelian') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.laporan.pembelian') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
                    ...
                    <a href="{{ route('owner.laporan.penjualan') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.laporan.penjualan') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4h16m-8 4l8 4-8 4V8z" /></svg>
                        Laporan Penjualan
                    </a>
                    <a href="{{ route('owner.laporan.gaji') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.laporan.gaji') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        Laporan Penggajian
                    </a>
                    <a href="{{ route('owner.laporan.tabungan') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.laporan.tabungan') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
            ...
            <div class="px-4">
                <p class="text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2 px-2">Monitoring</p>
                <div class="space-y-1">
                    <a href="{{ route('owner.keuangan.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.keuangan.*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h13m-4 4h4m-6 4h6" /></svg>
                        Keuangan
                    </a>
                    ...
                    <a href="{{ route('owner.pengguna.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.pengguna.*') ? 'bg-green-600 text-white' : 'text-zinc-400 hover:text-white hover:bg-zinc-800' }} text-sm transition">
