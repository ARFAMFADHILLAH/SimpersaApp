        ...
        <main class="flex-1 py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Referensi kontrol kinerja sebelum penggajian.</p>
                </div>

                <div class="p-4 sm:p-6 bg-white shadow sm:rounded-lg">
                    <form method="GET" action="{{ route('bendahara.absensi.index') }}" class="flex items-end gap-4">
                        <div>
                            <x-input-label for="bulan" value="Pilih Bulan" />
                            <x-text-input id="bulan" name="bulan" type="month" value="{{ $bulan }}" class="mt-1 block" />
                        </div>
                        <x-primary-button class="bg-emerald-700 hover:bg-emerald-800">Tampilkan</x-primary-button>
                    </form>
                </div>
