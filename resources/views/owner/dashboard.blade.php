        ...
        <main class="flex-1 py-8 px-6 sm:px-8 lg:px-10 overflow-y-auto">
            <div class="max-w-7xl mx-auto space-y-8">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b pb-4 border-gray-200 gap-4">
                    <div>
                        <h1 class="text-2xl font-black text-gray-900 tracking-tight">Pusat Pantauan Owner</h1>
                        <p class="text-xs text-gray-500 mt-1">Pantauan read-only laporan pendapatan, volume, kas, armada, petugas & kendala secara real-time</p>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800">
                            <span class="w-2 h-2 mr-1.5 bg-green-500 rounded-full animate-pulse"></span> Mode Owner (Read-Only)
                        </span>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-900 via-emerald-950 to-green-900 text-white p-6 rounded-2xl shadow-xl border border-green-900/50">
                    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto shrink-0">
                            <a href="{{ Route::has('owner.dss.index') ? route('owner.dss.index') : '#' }}" class="inline-flex justify-center items-center bg-green-600 hover:bg-green-500 text-white text-xs font-bold px-4 py-2.5 rounded-xl shadow transition">
                                Evaluasi Prioritas Wilayah
                            </a>
                            <a href="{{ Route::has('owner.laporan.index') ? route('owner.laporan.index') : '#' }}" class="inline-flex justify-center items-center bg-gray-800 hover:bg-gray-700 text-gray-200 text-xs font-bold px-4 py-2.5 rounded-xl border border-gray-700 transition">
                                Unduh Rekap Laporan
                            </a>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div class="bg-white p-5 rounded-2xl shadow-sm border border-gray-200 hover:shadow-md transition">
                        <div class="flex items-center justify-between text-gray-500 mb-3">
                            <span class="text-xs font-bold uppercase tracking-wider">Status Warga</span>
                            <div class="p-2 bg-green-50 text-green-600 rounded-lg">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                            </div>
                        </div>
                        <h4 class="text-2xl font-black text-gray-900">{{ number_format($totalWarga ?? 0) }} <span class="text-xs font-normal text-gray-500">Warga</span></h4>
                        <div class="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between text-xs">
                            <span class="text-green-600 font-bold">● {{ number_format($wargaAktif ?? 0) }} Aktif</span>
                            <span class="text-red-600 font-bold">● {{ number_format($wargaMenunggak ?? 0) }} Menunggak</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                <a href="{{ Route::has('owner.laporan.warga') ? route('owner.laporan.warga') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                    <span class="block text-xs font-bold text-gray-800 group-hover:text-green-600">Laporan Warga</span>
                                    <span class="text-[10px] text-gray-400 mt-0.5 block">Status & Tunggakan</span>
                                </a>

                                <a href="{{ Route::has('owner.laporan.iuran') ? route('owner.laporan.iuran') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                ...
                                <a href="{{ Route::has('owner.laporan.volume') ? route('owner.laporan.volume') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                ...
                                <a href="{{ Route::has('owner.laporan.keuangan') ? route('owner.laporan.keuangan') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                ...
                                <a href="{{ Route::has('owner.laporan.gaji') ? route('owner.laporan.gaji') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                ...
                                <a href="{{ Route::has('owner.laporan.armada') ? route('owner.laporan.armada') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                ...
                                <a href="{{ Route::has('owner.laporan.petugas') ? route('owner.laporan.petugas') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                    <span class="block text-xs font-bold text-gray-800 group-hover:text-green-600">Laporan Petugas</span>
                                    <span class="text-[10px] text-gray-400 mt-0.5 block">Kinerja & Beban Kerja</span>
                                </a>

                                <a href="{{ Route::has('owner.laporan.kendala') ? route('owner.laporan.kendala') : '#' }}" class="p-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50/30 transition text-left group">
                                    <span class="block text-xs font-bold text-gray-800 group-hover:text-green-600">Kendala Petugas</span>
                                    <span class="text-[10px] text-gray-400 mt-0.5 block">Kendala di Lapangan</span>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 pt-4 border-t border-gray-100 flex items-center justify-between">
                            ...
                            <a href="{{ Route::has('owner.laporan.index') ? route('owner.laporan.index') : '#' }}" class="text-xs font-bold text-green-600 hover:text-green-800">
