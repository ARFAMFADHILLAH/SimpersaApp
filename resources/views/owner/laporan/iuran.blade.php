        ...
        <main class="flex-1 py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Laporan Pendapatan (Iuran)</h2>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse($iuran as $i)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 font-mono text-xs">{{ $i->no_warga }}</td>
                                    <td class="px-6 py-4 font-medium">{{ $i->nama_warga }}</td>
