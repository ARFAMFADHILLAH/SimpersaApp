        ...
        <main class="flex-1 py-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('pelanggan.pengaduan.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs py-2 px-4 rounded-lg transition shadow-sm">+ Buat Pengaduan Baru</a>
                </div>
